...
namespace DenpadokeiFramework.Bases
{
    public class ViewModelBase : BindableBase, IDataContextInitializable, IDisposable
    {
        ...
        {
            if (sender is ILoadingService service && e.PropertyName == nameof(ILoadingService.IsLoading)) {
